		...
		if (isset($_POST["selected_borrower"])) {
			if ($_POST["borrower"] == "") {
				...
				if ($result == FALSE) {
					...
					$interest_accrued = ($_SESSION["interest_rate"]/360)*$number_of_days*$_SESSION["principal_balance"];
				}
			}
		}
	}
...
<head>
	...
	<title>HDF - Gathering EDA Payment Info</title>
...
<body>
	...
	<div id="container">
		...
		<div id="content_wrapper">
			<div id="title">
				<h2>Gathering EDA Payment Info:</h2>
			</div>

			<div id="content">
				<form id="form" name="get_info" action="./make_eda_payment.php" method="post">
					<p>
					...
					<input type="submit" name="got_info" value="Submit EDA Payment">
				</form>
			</div>
		</div>
	</div>
