<?php
	...
	if(isset($_SESSION["authenticated"])){
	    ...
	    $interest_applied = round((($_SESSION["interest_rate"]/360)*$number_of_days*$_SESSION["principal_balance"]), 2);
