<?php
	...
	if (isset($_SESSION["authenticated"])) {
        ...
        $sql = "SELECT * FROM current_eda_status ORDER BY current_eda_status.last_name ASC";
...
<head>
	...
	<title>HDF - Choose EDA Borrower</title>
</head>
		...
		<div id="content_wrapper">
			...
			<div id="content">
				...
				<?php if (mysql_num_rows($result)): ?>
					<form id="selection" name="select_borrower" action="./get_info.php" method="post">
						<?php
							$count = 0;
				...
				<?php  else: ?>
					<div id="message">
						<p>No Accounts in EDA Division at this time.<br>Do you want to <a href="../../add_borrower/">add</a> a borrower?</p>
					</div>
