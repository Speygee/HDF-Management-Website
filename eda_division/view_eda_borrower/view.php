	...
	if(isset($_SESSION["authenticated"])){
		if (isset($_POST["selected_borrower"])) {
			if ($_POST["borrower"] == "") {
			    ...
			    $current = "SELECT * FROM current_eda_status WHERE loan_id='$_POST[borrower]'";
			    $history = "SELECT * FROM eda_payment_history WHERE loan_id='$_POST[borrower]' ORDER BY `eda_payment_history`.`date_paid` DESC";
...
<head>
	...
	<title>HDF Viewing EDA Borrower</title>
</head>
