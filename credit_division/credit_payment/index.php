		...
		<div id="content_wrapper">
			...
			<div id="content">
				...
				<?php if (mysql_num_rows($result)): ?>
					<form id="form" name="select_borrower" action="./get_info.php" method="post">
						<?php
							$count = 0;
							while($row = mysql_fetch_array($result)){
								...
								$count++;
								if($count == 15){
									echo "<input id='submit' type='submit' name='selected_borrower' value='Continue'/><br>";
									$count = 0;
								}
							}
						?>
						<input type='submit' id="submit" name="selected_borrower" value='Continue'/><br>
					</form>
				<?php  else: ?>
					<div id="message">
