<?php
	...
	if(isset($_SESSION["authenticated"])){
		if (isset($_POST["editing_credit_borrower"])) {
			require "../../include.php";
	        ...
	        $insert = "INSERT INTO credit_edit_history (loan_id, first_name, last_name, suffix, date_paid, date_paid_to, cash_recieved, late_charges_applied, interest_applied, interest_rate, principal_applied, impound_applied, principal_balance, impound_balance, editor, date_edited) VALUES ('$_POST[loan_id]','$_POST[first_name]','$_POST[last_name]','$_POST[suffix]','$_POST[date_paid]','$_POST[date_paid_to]',$_POST[cash_recieved],$_POST[late_charges_applied],$_POST[interest_applied],$_POST[interest_rate],$_POST[principal_applied],$_POST[impound_applied],$_POST[principal_balance],$_POST[impound_balance],'$_SESSION[user]', '$today')";
	        	        
	        $insert_result = mysql_query($insert);
	        if (!$insert_result)
	        	die("Could Not Query Database.");
	        
	        $update = "UPDATE current_credit_status SET loan_id='$_POST[loan_id]', first_name='$_POST[first_name]', last_name='$_POST[last_name]', suffix='$_POST[suffix]', date_paid='$_POST[date_paid]', date_paid_to='$_POST[date_paid_to]', cash_recieved=$_POST[cash_recieved], late_charges_applied=$_POST[late_charges_applied], interest_applied=$_POST[interest_applied], interest_rate=$_POST[interest_rate], principal_applied=$_POST[principal_applied], impound_applied=$_POST[impound_applied], principal_balance=$_POST[principal_balance], impound_balance=$_POST[impound_balance], editor='$_SESSION[user]' WHERE `current_credit_status`.`loan_id`='$_SESSION[selected_borrower]'";
...
<head>
	...
	<title>HDF Credit Edit Receipt</title>
</head>
		...
		<div id="content_wrapper">
			...
			<div id="content">
				<div id="reciept">
					...
					<p>
						Cash Received: $<?= $_POST["cash_recieved"] ?>
					</p>
					<p>
