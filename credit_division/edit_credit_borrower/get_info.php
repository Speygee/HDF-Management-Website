...
<head>
	...
	<title>HDF - Gathering Credit Edit Info</title>
...
<body>
	...
	<div id="container">
		...
		<div id="content_wrapper">
			<div id="title">
				<h2>Apply Updated Information for Credit Borrower:</h2>
			</div>

			<div id="content">
				<form id="form" name="edit_borrower" action="./edit_credit_borrower.php" method="post">
				<?php while($row = mysql_fetch_array($result)): ?>
					...
					<input type="submit" name="editing_credit_borrower" value="Edit Credit Borrower">
				</form>
			<?php endwhile; ?>
			</div>
		</div>
